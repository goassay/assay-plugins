...
Sign in happens in the browser the first time the plugin talks to the marketplace.
    ...
    claude plugin marketplace add bakhtiyorjon-begmukhammadov/assay-plugins
    claude plugin install assay@assay

    codex plugin marketplace add bakhtiyorjon-begmukhammadov/assay-plugins
    codex plugin add assay@assay

Then, in any project: *"Publish this to Assay: what you want, budget 1000."*

Built from `skills/assay` in the main repository by `ops/plugins/build.sh`; version 0.1.0.
